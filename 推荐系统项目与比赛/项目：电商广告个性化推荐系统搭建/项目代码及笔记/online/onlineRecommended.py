...
class OnlineRecommended(object):
    ...
    MODEL_PATH = "/models/CTRModel_AllOneHot.obj"
    ...
    def create_redis_client(self):
        ...
        self.client_of_recall = redis.StrictRedis(host="192.168.58.100", port=6379, db=9)
        self.client_of_features = redis.StrictRedis(host="192.168.58.100", port=6379, db=10)
